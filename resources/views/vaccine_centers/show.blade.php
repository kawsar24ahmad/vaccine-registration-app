...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <caption class="p-5 text-lg font-semibold text-center rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
            ...
            <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">{{$vaccine_center->address}}</p>
            <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Daily Limit :  {{$vaccine_center->daily_limit}}</p>
        </caption>
        ...
        <tbody>
            @foreach ($vaccine_center->users as $user)
